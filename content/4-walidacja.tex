...
Po uruchomieniu urządzenia inicjalizowana jest stworzona biblioteka implementujące bezpieczną komunikację, a moduł Bluetooth zostaje skonfigurowany w trybie \emph{slave} z nazwą ,,seconn'' i oczekuje na połączenie. Przy inicjalizacji biblioteki przekazywane są następujące funkcje zaimplementowane w przykładowym oprogramowaniu:
