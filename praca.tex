...
\include{content/wstep}
\include{content/1-hardware}
\include{content/2-crypto}
\include{content/3-implementacja}
\include{content/4-walidacja}
\include{content/podsumowanie}
...
% itd.
\begin{appendices}
\include{content/dodatekA}
\include{content/dodatekB}
\include{content/dodatekC}
\include{content/dodatekD}
\include{content/dodatekE}
\end{appendices}
% itd.
